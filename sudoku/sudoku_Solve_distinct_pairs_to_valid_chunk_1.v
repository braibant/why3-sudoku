...
(* Why3 goal *)
Theorem distinct_pairs_to_valid_chunk : forall (g:(map Z Z)) (i:Z)
  (start:(map Z Z)) (offsets:(map Z Z)), (distinct_pairs g (get start i)
  offsets 9%Z 9%Z) -> (valid_chunk g i start offsets).
(* Why3 intros g i start offsets h1. *)
intros g i start offsets h1 h2.
unfold valid_chunk, distinct_pairs, distinct_pair in *. 
