...
(* Why3 assumption *)
Definition same_chunk (start:(map.Map.map Z Z)) (i:Z) (j:Z): Prop :=
  ((map.Map.get start i) = (map.Map.get start j)).
...
Axiom valid_chunk_ex2 : forall (g:(map.Map.map Z Z)) (i:Z) (j:Z) (x:Z)
  ...
  offsets) -> ((~ (same_chunk start i j)) -> (valid_chunk (map.Map.set g i x)
  j start offsets)))).
...
Definition equiv (i:Z) (j:Z): Prop :=
  ((map.Map.get (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.const (-1%Z)%Z:(map.Map.map
  Z Z)) 0%Z 0%Z) 1%Z 1%Z) 2%Z 2%Z) 3%Z 9%Z) 4%Z 10%Z) 5%Z 11%Z) 6%Z 18%Z) 7%Z
  19%Z) 8%Z 20%Z)
  i) = (map.Map.get (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.const (-1%Z)%Z:(map.Map.map
  Z Z)) 0%Z 0%Z) 1%Z 1%Z) 2%Z 2%Z) 3%Z 9%Z) 4%Z 10%Z) 5%Z 11%Z) 6%Z 18%Z) 7%Z
  19%Z) 8%Z 20%Z) j)) \/
  (((map.Map.get (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.set (map.Map.const (-1%Z)%Z:(map.Map.map
  Z Z)) 0%Z 0%Z) 1%Z 9%Z) 2%Z 18%Z) 3%Z 27%Z) 4%Z 36%Z) 5%Z 45%Z) 6%Z 54%Z)
...
Theorem valid_chunk_update_preserve : forall (g:(map.Map.map Z Z)) (i:Z)
  ...
  ((~ (equiv i j)) -> (valid_chunks (map.Map.set g i x) j))).
